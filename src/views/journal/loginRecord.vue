<template>
  <div class="main">
    ...
    <KPTable :event-bus="eventBus" :query-params="queryParams" :table-key="basic.tableKey" :list-api="basic.listApi" :table-column="tableColumn" :details-button-auth="basic.detailsButtonAuth" details-button-row />
