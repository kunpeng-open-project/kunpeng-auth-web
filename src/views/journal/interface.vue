<template>
	<div class="main">
		...
		<KPTable :event-bus="eventBus" :init-list="false" :table-key="basic.tableKey" :query-params="queryParams" :list-api="basic.listApi" :table-column="tableColumn" :details-button-row="basic.detailsButtonAuth" action-width="90px">
			<template #toolbar>
...
let basic: TableDialogColumn = {
	title: "接口调用记录",
	tableKey: "uuid",
	listApi: "/auth/interface/log/page/list",
	detailsApi: "/auth/interface/log/details",
	detailsButtonAuth: "auth:interface:log:details"
}
