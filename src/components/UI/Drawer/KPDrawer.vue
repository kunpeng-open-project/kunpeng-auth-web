<template>
  <el-drawer v-model="dialogVisible" :destroy-on-close="true" :show-close="false" :direction="direction" :lock-scroll="true" :close-on-press-escape="false" :modal="true" :with-header="true" :title="title" :size="size">
